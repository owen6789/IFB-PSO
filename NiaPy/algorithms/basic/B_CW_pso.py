...
__all__ = ['BCWParticleSwarmAlgorithm']


class BCWParticleSwarmAlgorithm:
        ...
        while self.eval_flag is not False:
            ...
            for i in range(self.NP):
                ...
                if self.iters_check[i] >= self.imp_check:
                    ...
                    chaotic_rnd = random.random() 
                    z = 4*chaotic_rnd*(1-chaotic_rnd)
                    self.w = (self.w_max-self.w_min)*((self.iter_max-iters_count+1)/self.iter_max)+self.w_min*z 
