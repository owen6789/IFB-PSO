...
__all__ = ['BLDWParticleSwarmAlgorithm']


class BLDWParticleSwarmAlgorithm:
    ...
    **Reference paper:**
    ...
    def __init__(self, D, NP, nFES, C1, C2, w, vMin, vMax, benchmark,imp_check,strategy):
        ...
        #======================== modified part ====================================
        # use isolation tree to find the anomaly
        # check the particles whether trapped local minimum
        # if the fitness value cannot improve more than imp_check iterations
        # view as trapping in local minimum
        self.strategy = strategy
        self.imp_check = imp_check 
        # array for counting the imp_check
        self.iters_check = numpy.zeros([self.NP])
        # records of the history of particles
        # index: [particle no.][iterations][particle]
