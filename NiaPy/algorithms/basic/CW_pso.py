...
__all__ = ['CWParticleSwarmAlgorithm']


class CWParticleSwarmAlgorithm:
    ...
    **Reference paper:**
    ...
    def move_particles(self):
        ...
        while self.eval_flag is not False:
            ...
            self.w = (self.w_max-self.w_min)*((self.iter_max-iters_count+1)/self.iter_max)+self.w_min*self.z 
