...
__all__ = ['LFBackwardParticleSwarmAlgorithm']

class LFBackwardParticleSwarmAlgorithm:
    ...
    **Reference paper:**
    ...
    def __init__(self, D, NP, nFES, C1, C2, w, vMin, vMax, benchmark, imp_check, strategy):
        ...
        # idex: [particle no.][iterations][particle]
    ...
    def move_particles(self):
        ...
        while self.eval_flag is not False:
            ...
            for i in range(self.NP):
                ...
                # Levy Flight
                elif self.iters_check[i] >= self.imp_check:
                    # do Levy Flight
